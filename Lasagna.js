 ...
 */
 ...
 export function remainingMinutesInOven(actualMinutesInOven) {
   let minutesRemainingInTheOven = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
   //throw new Error('Please implement the remainingMinutesInOven function');
   return minutesRemainingInTheOven
 }
 ...
 export function preparationTimeInMinutes(numberOfLayers) {
   ...
   let totalPreparationTime = PREPARATION_MINUTES_PER_LAYER * numberOfLayers;
 ...
 export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
   ...
   let totalWorkingTime = PREPARATION_MINUTES_PER_LAYER * numberOfLayers + actualMinutesInOven
