 ...
 */
 export function twoSum(array1, array2) {
    let sum1 = array1.join('')
    let sum2 = array2.join('')
  console.error('sum1', sum1);
  console.error('sum2', sum2);
  
  let array1Int = parseInt(sum1)
  let array2Int = parseInt(sum2)
  let sum = array1Int + array2Int
